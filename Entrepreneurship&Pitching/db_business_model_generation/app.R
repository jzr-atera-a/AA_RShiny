          ...
          column(12,
                 ...
                 div(class = "canvas-grid",
                     ...
                     div(class = "canvas-section customer-relationships relationships",
                         ...
                         div(class = "section-content",
                             p(strong("What type of relationship does each Customer Segment expect?")),
                             p(strong("Which ones have we established?")),
                             p(strong("How are they integrated?")),
                             p(strong("How costly are they?")),
                             hr(),
                             p(strong("Categories:")),
                             tags$ul(
                               tags$li("Personal assistance"),
                               tags$li("Dedicated assistance"),
                     ...
                     div(class = "canvas-section channels channels-grid",
                         ...
                         div(class = "section-content",
                             ...
                             tags$ul(
                               tags$li("1. Awareness"),
                               tags$li("2. Evaluation"),
                               tags$li("3. Purchase"),
                               tags$li("4. Delivery"),
                               tags$li("5. After sales")
                             )
                         )
                     ),
