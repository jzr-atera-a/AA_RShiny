...
ui <- dashboardPage(
  ...
  dashboardBody(
    tabItems(
      ...
      # Investor Research Tab - FIXED: Single wide box with database
      tabItem(tabName = "research",
              ...
              fluidRow(
                ...
                box(
                  title = "Geographic Investment Focus", status = "warning", solidHeader = TRUE,
                  width = 4,
                  div(class = "academic-content",
                      h5("Regional Investment Patterns"),
                      p("Geographic analysis reveals investor preferences for:"),
                      tags$ul(
                        tags$li("Local vs. remote investment comfort"),
                        tags$li("International expansion experience"),
                        tags$li("Regional market expertise"),
                        tags$li("Regulatory environment familiarity")
                      ),
                      p("Understanding geographic preferences helps prioritize investor outreach and meeting logistics.")
                  )
                )
              ),
              fluidRow(
      ...
      # Audience Profiling Tab - FIXED: Content within boxes and reactive selector
      ...
      # Pitch Alignment Tab - FIXED: Content within boxes and reactive selector
      ...
      # Networking Strategy Tab - FIXED: Tables within boxes
...
• Long-term partnership potential<br>
      ...
      # Follow-up Tracker Tab - FIXED: Tables within boxes
      ...
      # Resources Tab - FIXED: Content properly contained within boxes
...
server <- function(input, output, session) {
  ...
  output$action_items <- renderUI({
    div(class = "academic-content",
        h5("Priority Action Items"),
        div(class = "concept-highlight",
            HTML("<strong>High Priority:</strong><br>
          • Complete investor personality assessment (Due: 2025-09-17)<br>
          • Finalize financial model validation (Due: 2025-09-19)")),
        div(class = "concept-highlight",
            HTML("<strong>Medium Priority:</strong><br>
          • Conduct customer discovery interviews (Due: 2025-09-18)<br>
          • Schedule mentor advisory session (Due: 2025-09-21)")),
        div(class = "concept-highlight",
            HTML("<strong>Completed:</strong><br>
          • Update LinkedIn with recent achievements (Completed)"))
    )
  })
  
  # Investor Context
  div(class = "academic-content",
      h5("Sample (Ficticious) Investor Profiles"),
      div(class = "concept-highlight",
          HTML("<strong>Sarah Chen - TechVentures Capital:</strong> B2B SaaS focus, $500K-2M checks, Analytical decision style")),
      div(class = "concept-highlight",
          HTML("<strong>Mark Rodriguez - Innovation Growth:</strong> Healthcare tech, $1M-5M checks, Relationship-focused")),
      div(class = "concept-highlight",
          HTML("<strong>Emily Watson - Strategic Equity:</strong> Consumer internet, $250K-1M checks, Growth-oriented"))
  )
  ...
  # Academic Context
  div(class = "academic-content",
      h5("Strategic Networking Targets"),
      div(class = "concept-highlight",
          HTML("<strong>Primary Targets:</strong> Sarah Chen (TechVentures), Mark Rodriguez (Innovation Growth)")),
      div(class = "concept-highlight",
          HTML("<strong>Secondary Targets:</strong> Emily Watson (Strategic Equity), David Kim (Early Stage)")),
      div(class = "concept-highlight",
          HTML("<strong>Engagement Status:</strong> 2 meetings scheduled, 3 introductions pending"))
  )
  
  # Follow-up Pipeline
  div(class = "academic-content",
      h5("Active Follow-up Pipeline"),
      div(class = "concept-highlight",
          HTML("<strong>Immediate Actions:</strong> Sarah Chen follow-up (Sept 17), Competitive analysis for Mark Rodriguez (Sept 18)")),
      div(class = "concept-highlight",
          HTML("<strong>This Week:</strong> 3 scheduled follow-ups, 2 meeting requests pending")),
      div(class = "concept-highlight",
          HTML("<strong>Pipeline Health:</strong> 85% response rate, 12 active conversations"))
  )
}
