    ...
    fluidRow(
      box(title = "\U0001f4a1 How to Use This Tab", status = "warning",
        ...
        tags$p(style = "color:#8fb0d8;font-size:13px;line-height:1.7;margin:0;",
          tags$b(style = "color:#00e5ff;", "\U0001f4cb Comparison table: "),
          "the three-column table at the top compares SAFEs, convertible notes, and priced equity
          rounds across 9 criteria including legal cost, investor protection, and DeepTech suitability.
          Use this to choose the right instrument for your seed stage.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "\U0001f3b2 Conversion Calculator: "),
          "use the four sliders on the left to model your actual note terms:",
          tags$br(),
          tags$b(style = "color:#cdd9f5;", "Note Size"), ": how much you raised on the note. ",
          tags$b(style = "color:#cdd9f5;", "Valuation Cap"), ": the maximum pre-money at which the note converts. ",
          tags$b(style = "color:#cdd9f5;", "Discount"), ": the percentage discount vs Series A price. ",
          tags$b(style = "color:#cdd9f5;", "Series A Pre-Money"), ": your expected Series A valuation.",
          tags$br(), tags$br(),
          "The results panel shows your conversion price, note holder ownership percentage,
          effective pre-money for note holders, and whether the cap or discount triggers.
          A green box means cap triggered (note holders got a better deal via cap),
          blue means discount triggered.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "\U0001f4cc Key insight: "),
          "at a £28M Series A with an £8M cap and 20% discount, note holders convert at
          a dramatically lower price than new Series A investors: this is the fair
          compensation for taking the earliest risk. Make sure your cap is set appropriately
          for your expected Series A valuation or you may inadvertently over-dilute early believers."
        )
      )
    ),
