    ...
    fluidRow(
      box(title = "\U0001f4a1 How to Use This Tab", status = "warning",
        ...
        tags$p(style = "color:#8fb0d8;font-size:13px;line-height:1.7;margin:0;",
          ...
          "The term sheet is a 5:15 page document that determines your company's economic
          and governance outcome for the next decade. This tab gives you a framework for
          reading one quickly and correctly.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "Two tables to study: "),
          "the Economic Terms table (left) and Control Terms table (right) rate the importance
          of each provision for DeepTech companies specifically. The star ratings tell you
          where to focus your negotiating energy: fight hard on liquidation preferences
          and board composition, let go on dividends and information rights.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "Option Pool Shuffle box: "),
          "work through the numeric example carefully: this is the single most misunderstood
          term in a term sheet. The option pool is created from the pre-money, not post-money,
          meaning founders bear all the dilution. The counter-strategy is explained.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "\U0001f4cc Key takeaway: "),
          "Valuation is not the most important term. Liquidation preferences and board composition
          matter far more to your actual wealth at exit."
        )
      )
    ),
