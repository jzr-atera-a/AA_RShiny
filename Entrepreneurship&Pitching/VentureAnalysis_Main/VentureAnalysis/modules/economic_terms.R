    ...
    fluidRow(
      box(title = "\U0001f4a1 How to Use This Tab", status = "warning",
        ...
        tags$p(style = "color:#8fb0d8;font-size:13px;line-height:1.7;margin:0;",
          tags$b(style = "color:#00e5ff;", "\U0001f3b2 Interactive Exit Waterfall: "),
          "use the ",
          tags$b(style = "color:#cdd9f5;", "Exit Value slider"),
          " (top left) to set a hypothetical exit value for QuantumLeap AI.
          The stacked bar chart instantly shows how proceeds split between founders,
          Series A VC, and seed investors under three different liquidation preference structures.
          Try £30M, £60M, and £120M to see how the structures diverge at different exit sizes.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "Three structures compared: "),
          tags$b(style = "color:#cdd9f5;", "1x Non-Participating"),
          " (investor converts to common if exit is large enough: best for founders), ",
          tags$b(style = "color:#cdd9f5;", "1x Participating"),
          " (investor gets money back THEN shares in remaining proceeds), and ",
          tags$b(style = "color:#cdd9f5;", "2x Participating"),
          " (investor gets 2x first: most punishing for founders in moderate exits).",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "Anti-dilution chart: "),
          "the bar chart on the right shows how broad-based weighted average anti-dilution
          adjusts investor share price in a down round: and why full ratchet is so destructive.
          Use this to understand what you are agreeing to when signing anti-dilution provisions.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "\U0001f4cc Key takeaway: "),
          "at a £40M exit, founders receive dramatically different amounts depending on
          which liquidation structure they agreed to. Always model your likely exit range
          before accepting any participation rights."
        )
      )
    ),
