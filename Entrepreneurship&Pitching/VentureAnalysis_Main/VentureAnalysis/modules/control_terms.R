    ...
    fluidRow(
      box(title = "\U0001f4a1 How to Use This Tab", status = "warning",
        ...
        tags$p(style = "color:#8fb0d8;font-size:13px;line-height:1.7;margin:0;",
          tags$b(style = "color:#00e5ff;", "\U0001f4cc Purpose: "),
          "Control terms determine who runs the company. Founders routinely give away governance
          authority in pursuit of higher valuations: this tab explains why that is a dangerous trade.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "Board composition table: "),
          "study this carefully. At Series A, a 2-founder : 1-VC : 1-independent structure
          gives you a balanced board. An aggressive VC structure (1-founder : 2-VC : 1 VC-chosen independent)
          means you can be outvoted on any decision. The founder control column tells you exactly
          which configurations preserve your authority.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "Radar chart: "),
          "the three overlapping polygons show founder-friendly, typical market, and investor-heavy
          structures across seven control provisions. Larger polygon = more founder protection.
          Use this to benchmark where your term sheet sits vs market norms.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "Protective provisions: "),
          "the bullet list shows standard vs non-standard provisions. Standard ones (sale of company,
          new share issuance) are reasonable. Non-standard ones covering IP licensing or operational
          decisions are red lines: push back hard.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "\U0001f4cc Key takeaway: "),
          "the independent director is the swing vote on your board. Fight to nominate them yourself,
          subject to investor approval: not the other way around."
        )
      )
    ),
