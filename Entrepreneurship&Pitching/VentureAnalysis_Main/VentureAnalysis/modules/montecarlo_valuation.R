    ...
    fluidRow(
      box(title = "\U0001f4a1 How to Use This Tab", status = "warning",
        ...
        tags$p(style = "color:#8fb0d8;font-size:13px;line-height:1.7;margin:0;",
          tags$b(style = "color:#00e5ff;", "\U0001f916 What is a Monte Carlo simulation? "),
          "Instead of producing one exit value estimate, this model runs 10,000 different
          scenarios simultaneously: each drawing randomly from probability distributions
          for revenue growth, exit multiple, dilution, and time to exit.
          The result is a distribution showing not just what might happen, but how likely each outcome is.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "\U0001f3b2 How to use the sliders: "),
          "set your ", tags$b(style = "color:#cdd9f5;", "Base Case Revenue CAGR"),
          " and ", tags$b(style = "color:#cdd9f5;", "Revenue Uncertainty"),
          " to reflect your sector's growth profile (DeepTech hardware: 50:80% CAGR is realistic).
          Set your ", tags$b(style = "color:#cdd9f5;", "Mean Exit Revenue Multiple"),
          " based on comparable exits in your sector (Tab 10 has benchmarks).
          Set ", tags$b(style = "color:#cdd9f5;", "Expected Future Dilution"),
          " to model Series B+ rounds. Then click ",
          tags$b(style = "color:#cdd9f5;", "Run 10,000 Simulations"),
          " to generate results.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "Reading the charts: "),
          "the histogram shows the distribution of exit values: the wider the spread, the more
          uncertain the outcome. Vertical lines mark P10 (bear), median, and P90 (bull).
          The founder proceeds histogram applies your liquidation preference structure to show
          your personal wealth range. The bear/base/bull bar chart gives a boardroom-ready
          summary of three named scenarios.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "\U0001f4cc Key question to answer: "),
          "what is the probability your exit exceeds £100M? Check the stats panel.
          If it is below 30%, your investors will price that risk into their terms."
        )
      )
    ),
