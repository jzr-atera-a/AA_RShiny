    ...
    fluidRow(
      box(title = "\U0001f4a1 How to Use This Tab", status = "warning",
        ...
        tags$p(style = "color:#8fb0d8;font-size:13px;line-height:1.7;margin:0;",
          ...
          "Before negotiating with anyone, understand what they want and why they behave the way they do. ",
          tags$b(style = "color:#cdd9f5;", "Tab 1: The Players"),
          " covers who is in the room: GPs, LPs, angels, corporates, and lawyers.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "Use the sub-tabs: "),
          tags$b(style = "color:#cdd9f5;", "Who's In The Room"),
          " explains the VC fund structure, carry formula, and investor type comparison table.
          The formula boxes show how to calculate GP carry and fund return multiples: key
          to understanding why VCs behave the way they do at the negotiation table. ",
          tags$b(style = "color:#cdd9f5;", "DeepTech Application"),
          " translates this to QuantumLeap AI's specific situation: which investors to target,
          how to stack grants before the VC round, and what good legal counsel does for you.",
          tags$br(), tags$br(),
          tags$b(style = "color:#00e5ff;", "\U0001f4cc Key takeaway: "),
          "VCs are incentivised by carry (20% of profits above invested capital), not fees.
          This means they only make real money from genuinely great outcomes: align your pitch
          to show why you can be a fund-returner."
        )
      )
    ),
          ...
          tabPanel("\U0001f4da Who's In The Room",
            ...
            fluidRow(
              column(6,
                ...
                pull_quote("The best VCs aren't in it for the management fee. They're in it for the carry: and carry only comes from genuinely great companies.", "Brad Feld, Venture Analysis")
              ),
              column(6,
                sh("Key Formulas"),
                div(class = "mc-panel",
