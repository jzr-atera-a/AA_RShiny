...
2. Name it: **VentureAnalysis Analytics**
...
1. Open the JSON file — copy the `client_email` value (looks like `ventureanalysis-app@project.iam.gserviceaccount.com`)
...
rsconnect::deployApp(
  appDir  = "path/to/VentureAnalysis",
  appName = "venture-analysis"
)
```
