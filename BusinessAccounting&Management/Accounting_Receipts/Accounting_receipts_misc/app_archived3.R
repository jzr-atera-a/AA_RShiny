...
server <- function(input, output, session) {
  ...
  # Function to create renamed filename for "Files to Categorize"
  create_renamed_filename <- function(provider, description, date, amount, original_ext) {
    ...
    # Get first 20 characters of description (16 for general, 20 for trains/accommodation)
    ...
    # Combine: ProviderName_16CharsDescription_YYYYMMDD_Amount.ext
    new_filename <- paste0(
      provider_clean, "_",
      desc_clean, "_",
      date_formatted, "_",
