  ...
  tagList(
    fluidRow(
      box(
        ...
        p("Connect to your BigQuery dataset to store and retrieve funding programmes."),
        ...
        div(class = "alert alert-info",
            ...
            " Project: atera-2, Dataset: business_strategy, Table: funding_programmes"),
        ...
        fluidRow(
          ...
          column(6,
                 ...
                 textInput(ns("table_id"), 
                           "Table ID:",
                           value = "funding_programmes",
                           width = "100%"),
                 
                 p(style = "color: #7f8c8d; font-size: 12px;", 
                   "One row per programme: grants, incubators, accelerators, competitions")
          )
        ),
