  ...
  tagList(
    fluidRow(
      box(
        ...
        fluidRow(
          column(6, textInput(ns("diagram_id_existing"), "Existing Diagram ID (optional - leave blank to start a new diagram):")),
          column(6, textInput(ns("title"), "Diagram Title: *"))
        ),
        fluidRow(
          column(6, diagram_group_dropdown_ui(ns)),
        ...
        fluidRow(
          column(4, selectInput(ns("component_type"), "Component Type:",
                                choices = c("shape_rectangle", "shape_circle", "shape_ellipse", "axis", "axis_label",
                                            ...
                                            "data_point", "table_cell", "canvas_block", "margin_label"))),
          column(4, selectInput(ns("layout_role"), "Layout Role:",
                                choices = c("grid_cell", "quadrant_region", "axis", "list_item", "node", "title",
                                            "annotation", "support_activity", "primary_activity", "margin"))),
