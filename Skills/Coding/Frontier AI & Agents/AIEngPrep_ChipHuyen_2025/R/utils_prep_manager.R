...
PrepManager <- R6Class(
  ...
  public = list(
    ...
    initialize = function() {
      ...
      tabs <- c("overview","job_mapping","ch01_intro","ch02_foundation_models",
                "ch03_evaluation_methodology","ch04_evaluate_systems","ch05_prompt_engineering",
                "ch06_rag_agents","ch07_finetuning","ch08_dataset_engineering",
                "ch09_inference_optimization","ch10_architecture_feedback","practice")
      for (t in tabs) {
