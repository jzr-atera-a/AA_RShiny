# R/module_loader.R — AI Agents in Action Study Suite
...
ModuleLoader <- R6Class(
  ...
  public = list(
    ...
    load_packages = function() {
      ...
      required_pkgs <- c("shiny", "shinydashboard", "R6", "yaml", "purrr",
                         "magrittr", "dplyr", "DT", "plotly", "jsonlite")
