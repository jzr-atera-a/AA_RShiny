...
cat("\n╔════════════════════════════════════════════════════╗\n")
cat("║  META ML INTERVIEW PREP SUITE v1.0 - LOADING      ║\n")
cat("╚════════════════════════════════════════════════════╝\n\n")
...
# Initialize SHARED Prep Manager (reactive — must be inside server)
# We create a non-reactive version here and initialise reactive fields in server
...
# Server Factory — CRITICAL: do NOT pass session to module servers
