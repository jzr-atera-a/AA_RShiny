  ...
  tagList(
    div(class = "aa-hero",
        ...
        div(
          ...
          span(class = "hero-badge", icon("clipboard-check"), " Interview Checklist")
        )
    ),
          ...
          tabPanel("\U0001f4da General Concepts",
            ...
            fluidRow(
              column(6,
                ...
                sh("Interview Checklist"),
                concept_card("The Pre-Interview Checklist Every Spokesperson Should Run",
                  "Before any media interview, run through a fixed checklist rather than relying on 
                  memory under pressure: 
                  <b>(1)</b> Confirm the outlet, journalist, format and likely running time; 
                  <b>(2)</b> Agree what is and is not on the record; 
                  <b>(3)</b> Write down your three Message House points and one soundbite for each; 
                  <b>(4)</b> Prepare answers to the three toughest questions you could be asked; 
                  <b>(5)</b> Check camera framing, lighting, background and audio if it is a video interview; 
                  <b>(6)</b> Agree who else needs to be briefed before the piece runs. 
                  A checklist run in the same order every time removes the risk of last-minute panic 
                  replacing preparation."),

                div(class = "tip-box",
                    tags$strong("\U0001f4a1 Key point: "),
                    "The checklist should be run whether the interview is a five-minute radio slot or a 
                    thirty-minute televised panel - preparation quality should not scale down with 
                    perceived stakes, because a short slot offers no time to recover from a bad start.")
              ),
              ...
              column(6,
                ...
                div(class = "success-box",
                    ...
                    Prepare your soundbites. Run the interview checklist every time. 
                    Know the dirty tricks. And remember: everything is on the record 
          ...
          tabPanel("\U0001f3e2 Applicability on Atera Analytics",
            ...
            fluidRow(
              ...
              column(6,
                ...
                shg("Atera\u2019s Interview Checklist"),
