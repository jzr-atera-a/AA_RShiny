      ...
      box(title = NULL, status = "primary", solidHeader = FALSE, width = 12,
        tabsetPanel(
          ...
          tabPanel("\U0001f4da General Concepts",
            ...
            fluidRow(
              ...
              column(6,
                ...
                concept_card("The Cost of Every Extra Word",
                  "Every additional sentence is a small tax on your reader\u2019s attention and goodwill. 
                  Before sending anything, ask: <em>what can I cut without losing meaning?</em> 
                  A ruthless edit pass - removing throat-clearing openings, redundant qualifiers 
                  and repeated points - almost always improves both clarity and impact.")
              )
            ),
            ...
            fluidRow(
              column(6,
                ...
                concept_card("Consistency Builds Recognition",
                  "Voice becomes powerful only when it is consistent. If your emails, reports and 
                  presentations all sound like different people wrote them, your audience never builds 
                  a relationship with a single, trusted communicator. Decide on your voice once, then 
                  apply it everywhere - from the shortest Slack message to the longest report."),
              ...
              column(6,
                ...
                div(class = "success-box",
                    ...
                    borrow wisdom responsibly, commit to brevity, make yourself likeable, 
                    allow your voice and style through, and plan your one moment of surprise.")
              )
            ),
            ...
            fluidRow(
              column(6,
                sh("The Wisdom of Mark Twain, or Beatrix Potter, or Woodrow Wilson, or Someone"),
                concept_card("Borrowed Wisdom: Why Quotations Persuade",
                  "A well-chosen quotation lends instant authority to your message. It signals that 
                  a sharper mind than the room\u2019s has already tested the idea and found it true. 
                  Quotations compress complex arguments into a single memorable line, and because they 
                  arrive in someone else\u2019s voice, they can say things more boldly than you could say 
                  in your own."),

                concept_card("Verify Before You Borrow",
                  "The line <em>\u2018If I had more time, I would have written a shorter letter\u2019</em> 
                  has been credited to Mark Twain, Blaise Pascal, Cicero, Woodrow Wilson and half a dozen 
                  others - nobody is entirely sure who said it first. The same fate befalls many quotes 
                  pinned on Beatrix Potter, Churchill or Einstein. The lesson: check attribution before 
                  you quote. A misattributed quote used with false confidence can quietly undermine your 
                  credibility the moment a sharp-eyed audience member fact-checks it."),

                quote_block(
                  "If I had more time, I would have written a shorter letter.",
                  "Widely misattributed to Mark Twain, Blaise Pascal, Woodrow Wilson and others"
                ),

                div(class = "tip-box",
                    tags$strong("\U0001f4a1 Practical rule: "),
                    "If you cannot find a primary source for a quote in under two minutes, either verify 
                    it properly, attribute it as \u2018often attributed to\u2026\u2019, or leave it out entirely.")
              ),

              column(6,
                sh("Making Yourself Popular"),
                concept_card("People Read - and Trust - Communicators They Like",
                  "Technical accuracy earns respect, but likeability earns attention. Warmth, humility 
                  and a willingness to credit others make an audience want to keep reading and keep 
                  listening. Communicators who only ever project authority and never warmth are 
                  technically correct and commercially forgettable."),

                concept_card("Small Acts That Build Rapport",
                  "Popularity in communication is built from small, repeatable habits: 
                  <b>(1)</b> open with genuine interest in the reader\u2019s situation, not your own agenda; 
                  <b>(2)</b> credit collaborators and partners by name; 
                  <b>(3)</b> admit uncertainty or a misstep plainly rather than spinning it; 
                  <b>(4)</b> use light, appropriate humour to signal you are a human, not a press release. 
                  None of these cost anything, and all of them compound over repeated contact."),

                div(class = "success-box",
                    tags$strong("\u2705 Key point: "),
                    "Likeability is not the opposite of authority - the two combine into trust, 
                    which is the actual currency of effective communication.")
              )
            ),
            ...
            fluidRow(
              column(6,
                sh("Strutting Your Style"),
                concept_card("Style Is a Deliberate Choice, Not an Accident",
                  "Where voice is your underlying personality, style is the deliberate set of craft 
                  choices you make on top of it: sentence length and rhythm, how you open and close, 
                  the words you reach for under pressure. Strutting your style means making these 
                  choices on purpose, rather than defaulting to whatever generic template your industry uses."),

                concept_card("Signature Moves You Can Build",
                  "Distinctive communicators often have one or two recognisable habits: a trademark 
                  short sentence to land a point, a consistent way of opening every update, a recurring 
                  turn of phrase used only for good news. Choose one or two signature moves, use them 
                  deliberately and consistently, and your audience will start to recognise your writing 
                  before they reach the signature."),

                div(class = "tip-box",
                    tags$strong("\U0001f4a1 Key test: "),
                    "Could a colleague identify a piece of writing as yours with the name removed? 
                    If not, your style has not yet found its edges.")
              ),

              column(6,
                sh("Style in Practice"),
                concept_card("When Style Should Step Back",
                  "Style must always serve the message, never obscure it. If a reader has to work to 
                  find the point beneath the flourish, the style has failed - no matter how elegant it 
                  sounds in isolation. The best-styled communicators are invisible in one sense: readers 
                  remember what was said, and only notice afterwards how well it was said."),
                example_pair(
                  bad_text  = "Please be advised that, pursuant to our ongoing programme of works, we wish 
                  to inform all stakeholders that milestone deliverables remain on track for the current 
                  reporting period.",
                  good_text = "Good news: we\u2019re on track. Milestone three lands this month, exactly as planned."
                )
              )
            )
          ...
          tabPanel("\U0001f3e2 Applicability on Atera Analytics",
            ...
            fluidRow(
              column(6,
                shg("Borrowed Wisdom for Atera\u2019s Pitches"),
                app_card("Quotable Authority for Grant and Investor Decks",
                  "Atera can open milestone reports or investor decks with a properly-sourced line from 
                  a named, checkable authority - a DfT policy statement, a cited Innovate UK strategy 
                  document, or a named academic collaborator at Cambridge or Oxford. A verified quote 
                  from a real named partner does more for credibility than an unattributed \u2018industry 
                  experts agree\u2019 claim ever will."),
                app_card("Verify Every External Statistic Before It Goes in a Deck",
                  "Any market-size figure, government investment number or third-party statistic used in 
                  an Atera pitch must be traceable to a named, dated source. A single unverifiable number 
                  discovered by a due-diligence analyst can cost more credibility than the number itself 
                  ever added.")
              ),
              column(6,
                shg("Making Atera Popular with Councils and Partners"),
                app_card("Warmth in a Public-Sector Relationship",
                  "Council officers and Innovate UK monitors deal daily with vendors who only appear when 
                  they want something. Atera can stand out simply by opening emails with genuine interest 
                  in the council\u2019s own priorities, crediting named officers in public updates, and 
                  being the first to flag a slipped date rather than waiting to be asked."),
                app_card("Likeability as a Renewal and Referral Driver",
                  "In a market this small, councils and AV operators talk to each other. A monitoring 
                  officer or partner who finds Atera easy and pleasant to deal with - not just technically 
                  competent - is far more likely to renew, refer Atera to a neighbouring authority, or 
                  speak well of the project at a Zenzic review.")
              )
            ),
            ...
            fluidRow(
              column(12,
                shg("Atera\u2019s Signature Style"),
                app_card("A Recognisable Atera Voice Across All Materials",
                  "Every Atera-facing document - milestone reports, council one-pagers, LinkedIn posts, 
                  investor updates - should share small, deliberate signature moves: the sat-nav analogy 
                  used consistently to explain the platform, a fixed one-line opening for good-news updates 
                  (\u2018Good news: we\u2019re on track\u2019), and a plain-English glossary box whenever a technical 
                  term is unavoidable. A reader should be able to recognise an Atera document by its style 
                  alone, well before they reach the logo."),
                div(class = "success-box",
                    tags$strong("\u2705 Chapter 1 Action Point: "),
                    "Draft a one-page Atera style sheet: the sat-nav analogy, the standard good-news 
                    opening line, and the rule that any borrowed statistic or quote must carry a named, 
                    checkable source.")
              )
            )
          ) # end Atera tab
