  ...
  tagList(
    ...
    fluidRow(
      box(title = "\U0001f3c1 The Book in One Page", status = "primary",
          ...
          fluidRow(
            ...
            column(6,
              sh("Atera\u2019s Single Unifying Golden Thread"),
              quote_block(
              ...
              concept_card("\U0001f947 Priority 1 - This Week",
                  "Write the Golden Thread for all 4 audience groups. 
              ...
              concept_card("\U0001f948 Priority 2 - This Month",
                  "Build the story bank (6 entries). 
              ...
              concept_card("\U0001f949 Priority 3 - This Quarter",
                  "Write the full strategic communication plan. 
    ...
    fluidRow(
      box(title = "\U0001f5fa\ufe0f Atera\u2019s Complete Communication Roadmap", status = "success",
          ...
          fluidRow(
            column(3,
              app_card("\U0001f4dd Foundations (Ch 1\u20133)",
            ...
            column(3,
              app_card("\U0001f4d6 Storytelling (Ch 4\u20135)",
            ...
            column(3,
              app_card("\U0001f3a4 Speaking (Ch 6\u20137)",
            ...
            column(3,
              app_card("\U0001f4e3 Strategic (Ch 8\u201310)",
    ...
    fluidRow(
      ...
      box(title = "\U0001f3af The Final Word", status = "primary",
          solidHeader = TRUE, width = 6,
          concept_card("What Separates Good Communicators from Great Ones",
          ...
          concept_card("Atera\u2019s Communication Opportunity",
              "Atera Analytics has a genuinely compelling story to tell: 
