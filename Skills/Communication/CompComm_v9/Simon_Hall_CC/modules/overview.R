  ...
  tagList(
    ...
    fluidRow(
      ...
      box(title = "\U0001f5fa\ufe0f Chapters Covered", status = "info",
          ...
          toc_item("8", HTML("<b>The Online World</b> - The Golden Rule, your bio, platforms, tags and hashtags, photography, videography, blogs, AI and trolls")),
          toc_item("9", HTML("<b>Mixing It with the Media</b> - News releases, journalist calls, the Message House, bridging, soundbites, interview checklists and dirty tricks")),
          toc_item("10", HTML("<b>Strategic Communication</b> - Setting your goal, bad news, kitchen sinking, crisis communication and recovery plans"))
      )
    ),
