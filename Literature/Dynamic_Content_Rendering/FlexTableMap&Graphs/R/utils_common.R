# R/utils_common.R
# Shared Utility Functions - UNIFIED Flex Table + Mind Map + Knowledge
# Graph Suite
# =====================================================================
# This file merges the three sibling apps' utils_common.R files. Only
...
# Everything else keeps its original per-app name, since the three
# data models (flexible comparison tables / versioned trees / versioned
# entity-relationship graphs) are genuinely different and their parsers,
# validators, and prompt builders should not be conflated.
