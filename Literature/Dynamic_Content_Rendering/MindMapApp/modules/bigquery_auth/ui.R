  ...
  tagList(
    fluidRow(
      box(
        ...
        p("Connect to your BigQuery dataset to store and retrieve mind maps."),
        ...
        div(class = "alert alert-info",
            ...
            " Project: atera-2, Dataset: Wonderfulp_March, Table: mindmap_nodes",
            tags$br(),
            tags$strong("Schema:"),
            " id, created_at, source, change_type, category, domain, topic, map_id, map_title, ",
            "node_id, node_label, node_content, parent_node_id, cross_links, sort_order. Append-only: ",
