    ...
    fluidRow(
      box(title = "About Strategic Analysis", status = "primary", solidHeader = TRUE, width = 12,
          ...
          p("One row = one visual component (a grid cell, a quadrant, an axis, a chart series). Denormalized: ",
            "diagram_name/diagram_type/category/topic/title are repeated on every row belonging to the same ",
          ...
          tags$table(class = "table table-striped",
            ...
            tags$tbody(
              ...
              tags$tr(tags$td("diagram_name / diagram_type"), tags$td("Human label + one of the 11 renderer-dispatch enum values")),
