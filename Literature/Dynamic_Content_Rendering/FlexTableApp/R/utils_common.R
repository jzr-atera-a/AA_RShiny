...
generate_table_prompt <- function(category, topic, table_title,
  ...
  prompt <- paste0(
    ...
    '   - Each column VALUE should be a concise but substantive explanation (1-4 sentences) specific to that row/column intersection - explain relative strengths, weaknesses, or comparison points, not just a generic description.\n',
