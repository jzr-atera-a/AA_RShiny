...
# Create bulk_import module
cat > modules/bulk_import/ui.R << 'EOFUI'
...
cat > modules/bulk_import/server.R << 'EOFSERVER'
...
cat > modules/bulk_import/README.md << 'EOFREADME'
# Bulk Import Module

Parse and upload book summaries in bulk to BigQuery.
EOFREADME

echo "✓ Created bulk_import module"

# Create manifests for remaining modules
cat > modules/bulk_import/manifest.yml << 'EOFMANIFEST'
module:
  id: "bulk_import"
  name: "Bulk Import"
  description: "Parse and upload summaries in bulk"
  version: "1.0.0"
  author: "Book Summary Suite Team"
  enabled: true
  menu:
    label: "Bulk Import"
    icon: "file-import"
