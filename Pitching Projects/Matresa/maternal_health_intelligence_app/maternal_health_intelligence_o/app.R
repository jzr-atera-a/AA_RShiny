# app.R - Maternal Health Intelligence App Entry Point
...
if (length(module_functions) > 0) rm(list = module_functions, envir = .GlobalEnv)
...
cat("\n  Launching Maternal Health Intelligence App...\n\n")
