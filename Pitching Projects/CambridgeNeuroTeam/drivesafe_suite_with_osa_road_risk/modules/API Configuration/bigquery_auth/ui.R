...
# DriveSafe Suite - BigQuery authentication
# One table: atera-2.business_strategy.driver_health_log
  ...
  tagList(
    fluidRow(
      box(
        ...
        h4("Connect to BigQuery - DriveSafe Driver Health Log"),
        ...
        fluidRow(
          ...
          column(6,
            ...
            tags$table(class = "table table-condensed",
              tags$tbody(
                tags$tr(
                  tags$td(tags$strong("DriveSafe table:")),
                  tags$td(tags$code("driver_health_log"))
                )
              )
            ),
