...
unit3_live_signals_ui <- function(id) {
  ...
  tagList(
    ...
    u3ls_step("How to use the Economic Calendar alongside this tool",
      tags$p("Before the trading week: check Economic Calendars \u2192 Daily/Weekly Trend Summary for high-importance events relevant to whatever asset class you're trading. Knowing a rate decision or a jobs release is coming lets you decide in advance \u2014 as part of your plan, not in the moment \u2014 whether to trade through it, widen a stop, or sit it out."),
      tags$p("During or after the week: if a trigger fires here that looks unusual, or price moves sharply outside a normal setup, check Economic Calendars \u2192 Visualisation for that date and asset. If a stored calendar event lines up, that's a real, checkable fact you can cite in Task 2 when explaining a deviation \u2014 for example, \u201cI widened my stop ahead of the NFP release logged for that day\u201d is a specific, evidenced statement rather than a vague one.")
    ),
