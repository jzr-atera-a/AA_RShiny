...
unit3_assignment_ui <- function(id) {
  ...
  tagList(
    ...
    ua_references(
      ua_ref("<b>Barber, B.M., Lee, Y.T., Liu, Y.J. and Odean, T. (2014)</b> \u2018The Cross-Section of Speculator Skill: Evidence from Day Trading\u2019, <i>Journal of Financial Markets</i>, 18, pp. 1\u201324.",
      ...
      ua_ref("<b>Markowitz, H. (1959)</b> <i>Portfolio Selection: Efficient Diversification of Investments</i>. New York: John Wiley &amp; Sons (Cowles Foundation Monograph 16).",
             "https://www.jstor.org/stable/j.ctt1bh4c8h"),
      ...
      ua_ref("<b>FundedFast (2026)</b> <i>Trading Risk Management: Protecting Your Capital</i> \u2014 summarises Barber et al. (2014) on day-trader profitability.",
