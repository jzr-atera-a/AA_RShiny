  ...
  tagList(
    fluidRow(
      box(
        ...
        div(style = "display:flex; align-items:center; gap:16px; flex-wrap:wrap;",
            ...
            tags$span("Fill in the fields below, then download a print-ready PDF matching the trade sheet template.",
    ...
    fluidRow(
      box(title = "Trade Sheet", status = "primary", solidHeader = TRUE, width = 12,
        textInput(ns("studentName"), "Name:", value = "", width = "100%"),
  ...
  moduleServer(id, function(input, output, session) {
    ...
    output$downloadTradeSheet <- downloadHandler(
      ...
      content = function(file) {
        ...
        graphics::mtext(paste0("Trading Analysis F1 \u2014 ", input$studentName %||% ""), side = 1, outer = FALSE,
