          ...
          fluidRow(
            column(8,
              ...
              tags$p(HTML(paste0(
                ...
                "around a structured, step-by-step trading and technical analysis curriculum."
              ...
              tags$p(HTML(paste0(
                ...
                "(Trading Economics and Financial Modeling Prep), curriculum-aligned derivatives calculators, ",
    ...
    fluidRow(
      box(
        ...
        tags$p(paste0(
          ...
          "Economic Calendars (Trading Economics + Financial Modeling Prep), Risk & Portfolio Analytics, ",
          "Step-by-Step Practice (Steps 1\u20136, working through a structured set of activity sheets), Trade Journal ",
          "(a fillable Individual Trade Sheet), and About & Feedback (this group). Click any group name to ",
          "expand its individual tabs."
        ...
        lapply(list(
          ...
          list(icon = "chalkboard-user", title = "Step-by-Step Practice (Steps 1\u20136)", color = "#9b59b6",
               text = "Reproduces every exercise from a structured set of activity sheets using simulated OHLC data: Step 1 (S/R, trend lines, candlesticks), Step 2 (Fibonacci, chart patterns), Step 3 (RSI/Stochastic/MA/MACD/OBV/Bollinger), Step 4 (Bull/Bear cycle, options trading & payouts), Step 5 (Volume Profile, Market Profile, Initial Balance), and Step 6 (Straddle trading, Pivot Point Bounce, Holy Grail, ADX, DMI). Each step's tab has a Download PDF button."),
          list(icon = "file-invoice", title = "Trade Journal", color = "#34495e",
               text = "An Individual Trade Sheet matching a standard trade-journal layout — entry setup/trigger/execution, chart image uploads, an editable trade-exit table for partial exits, and a Download PDF button that lays the filled sheet out for printing or submission.")
        ), function(m) {
