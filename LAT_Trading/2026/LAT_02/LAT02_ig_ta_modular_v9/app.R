...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("Weekly Activity", icon = icon("chalkboard-user"),
        menuSubItem("Week 1", tabName = "weekly_activity_week1", icon = icon("1")),
        menuSubItem("Week 2", tabName = "weekly_activity_week2", icon = icon("2")),
        menuSubItem("Week 3", tabName = "weekly_activity_week3", icon = icon("3")),
        menuSubItem("Week 4", tabName = "weekly_activity_week4", icon = icon("4")),
        menuSubItem("Week 5", tabName = "weekly_activity_week5", icon = icon("5")),
        menuSubItem("Week 6", tabName = "weekly_activity_week6", icon = icon("6"))
      ),
