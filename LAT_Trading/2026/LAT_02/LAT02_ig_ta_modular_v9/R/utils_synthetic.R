...
# Cover page: week title, student name, course line + link, generation date.
draw_pdf_cover_page <- function(week_title,
                                 student_name = "Jose Zubizarreta",
                                 course_line  = "London Academy of Trading \u2014 Level 5 Diploma in Applied Financial Trading 2026",
                                 course_url   = "https://canvas.lat.london/courses/41") {
  graphics::par(mfrow = c(1, 1), mar = c(0, 0, 0, 0), oma = c(0, 0, 0, 0))
  graphics::plot.new()
  graphics::plot.window(xlim = c(0, 1), ylim = c(0, 1))
  graphics::text(0.5, 0.60, week_title, cex = 2.3, font = 2, col = "#002C3C")
  graphics::text(0.5, 0.49, student_name, cex = 1.5, font = 2, col = "#002C3C")
  graphics::text(0.5, 0.43, course_line, cex = 1.05, col = "#333333")
...
# A4 PDF. A cover page carries the week/student/course details. 4 charts per page (2x2),
...
# section spans, and a running student/course footer prints at the bottom of every
...
export_weekly_pdf <- function(file, week_title, sections,
  ...
  per_page <- 4
  footer_text <- paste0(student_name, "  \u2014  ", course_line)
...
# ══════════════════════════════════════════════════════════════════════════
# VOLUME PROFILE PRIMITIVES (Week 5) — built entirely from existing shapes/
