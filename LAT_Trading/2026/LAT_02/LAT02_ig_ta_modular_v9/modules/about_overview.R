    ...
    fluidRow(
      box(
        ...
        tags$p(paste0(
          ...
          "Weekly Activity (Weeks 1\u20136, reproducing the course's weekly activity sheets), Trade Journal ",
        ...
        lapply(list(
          ...
          list(icon = "chalkboard-user", title = "Weekly Activity (Weeks 1\u20136)", color = "#9b59b6",
               text = "Reproduces every exercise from the course's weekly activity sheets using simulated OHLC data: Week 1 (S/R, trend lines, candlesticks), Week 2 (Fibonacci, chart patterns), Week 3 (RSI/Stochastic/MA/MACD/OBV/Bollinger), Week 4 (Bull/Bear cycle, options trading & payouts), Week 5 (Volume Profile, Market Profile, Initial Balance), and Week 6 (Straddle trading, Pivot Point Bounce, Holy Grail, ADX, DMI). Each week's tab has a Download PDF button."),
          list(icon = "file-invoice", title = "Trade Journal", color = "#34495e",
               text = "An Individual Trade Sheet matching the course's paper template — entry setup/trigger/execution, chart image uploads, an editable trade-exit table for partial exits, and a Download PDF button that lays the filled sheet out for printing or submission.")
        ), function(m) {
