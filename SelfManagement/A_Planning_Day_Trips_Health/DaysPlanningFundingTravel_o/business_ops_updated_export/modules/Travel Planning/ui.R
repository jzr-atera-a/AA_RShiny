  ...
  tagList(
      ...
      box(
        ...
        fluidRow(
          column(6,
                 ...
                 p(class = "text-muted", style = "font-size: 0.9em;",
                   "Plan your itinerary across 1-7 days.")
          ),
          column(6,
                 h5("Daily Schedule:"),
    ...
    fluidRow(
      box(
        ...
        h4("Interactive Map"),
        p(class = "text-muted",
          "Map display with markers for each attraction and suggested routes will appear here."),
        
        div(id = ns("map_placeholder"), 
            style = "width: 100%; height: 500px; border: 2px dashed #ccc; border-radius: 4px; display: flex; align-items: center; justify-content: center; background-color: #f5f5f5;",
            div(style = "text-align: center;",
                icon("map", style = "font-size: 48px; color: #999;"),
                h4("Map Placeholder", style = "color: #999;"),
                p("Interactive map will be rendered here", style = "color: #999;")
            )
        ),
