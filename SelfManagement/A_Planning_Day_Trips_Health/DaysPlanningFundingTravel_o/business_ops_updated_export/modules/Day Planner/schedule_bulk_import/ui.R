# modules/Day Planner/schedule_bulk_import/ui.R

schedule_bulk_import_ui <- function(id) {
  ns <- NS(id)
  ...
  tagList(
    fluidRow(
      box(
        ...
        fluidRow(
          column(4, actionButton(ns("parse"), "Parse Schedule", class = "btn-info btn-lg", icon = icon("cogs"), width = "100%")),
