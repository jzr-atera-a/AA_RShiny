  ...
  tagList(
    ...
    fluidRow(
      box(
        ...
        # Navigation & GPS Exports
        fluidRow(
          column(4,
                 downloadButton(ns("download_kml"), "🗺️ Google Maps (.kml)", 
                               class = "btn-info", style = "width: 100%;")
          ),
          column(4,
                 downloadButton(ns("download_gpx"), "📍 GPS Navigation (.gpx)", 
                               class = "btn-info", style = "width: 100%;")
          ),
          column(4,
                 downloadButton(ns("download_google_maps_url"), "🔗 Google Maps Link", 
                               class = "btn-info", style = "width: 100%;")
          )
        ),
