      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            div(class = "help-section",
                h3("Converting HTML to PDF"),
                tags$ol(
                  tags$li(tags$strong("Select HTML Files:"), " Click 'Browse Files' and choose 1-8 HTML files."),
                  tags$li(tags$strong("Choose Output Folder:"), " Click 'Select Folder' to choose where PDFs will be saved."),
                  tags$li(tags$strong("Configure Settings:"), " Select page size, orientation, page range, and scale."),
                  tags$li(tags$strong("Convert:"), " Click 'Convert to PDF' to start the conversion process.")
                )
            ),
            div(class = "help-section",
            ...
            div(class = "help-section",
                ...
                tags$ul(
                  ...
                  tags$li("The fixed version ensures content fits within page boundaries with no overflow")
                )
            )
          )
        )
...
server <- function(input, output, session) {
  ...
  # Helper function for exact page dimensions
  ...
  # Helper function for page dimensions text
  ...
  # Copy to converter functionality
  observeEvent(input$copy_to_converter, {
    req(rv$generated_html_file)
    updateTabItems(session, "sidebar", "converter")
    showNotification("Navigate to 'Convert to PDF' tab to convert your generated diagram", 
                     type = "message", duration = 5)
  })
  
  # Original PDF conversion functionality
