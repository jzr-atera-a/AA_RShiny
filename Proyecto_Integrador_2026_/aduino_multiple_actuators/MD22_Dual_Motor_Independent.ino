...
const byte MD22_ACCELERATION_REG = 0x0E;     // Acceleration register
const byte MD22_MODE_REG = 0x0F;             // Mode register
const byte MD22_VERSION_REG = 0x07;          // Software version
const byte MD22_VOLTAGE_REG = 0x0A;          // Battery voltage
...
void initMD22() {
  ...
  // Test connection
  Serial.print("  Checking address 0x58... ");
  ...
  byte voltageRaw = readMD22Register(MD22_VOLTAGE_REG);
  ...
  // Set acceleration to 1 (fast response)
  Serial.print("  Setting acceleration to 1... ");
  writeMD22Register(MD22_ACCELERATION_REG, 1);
  delay(50);
