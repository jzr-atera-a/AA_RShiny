 ...
 *   - MD22 Motor1 via I2C (Speed: 50-80% forward) - Controlled by LEFT joystick Y
 *   - MD22 Motor2 via I2C (Speed: 50-80% forward) - Controlled by LEFT joystick Y
 *
 * Hardware:
 ...
 *   MOTOR1:speed      - Set motor1 speed (50-80 for 50-80% forward)
 *   MOTOR2:speed      - Set motor2 speed (50-80 for 50-80% forward)
 *   MOTORS:speed      - Set both motors to same speed (50-80%)
 *   M1_STOP           - Stop motor1
 *   M2_STOP           - Stop motor2
...
// Motor speed limits (50-80% of full speed for 4-wheel robot - SAFETY)
const int MOTOR_MIN_PERCENT = 50;  // Motors don't move below 50%
const int MOTOR_MAX_PERCENT = 80;  // SAFETY: Limited to 80% (was 90%)
...
int currentMotor1Speed = 0;         // Current motor1 speed (50-80%)
int currentMotor2Speed = 0;         // Current motor2 speed (50-80%)
