  ...
  dashboardPage(
    ...
    dashboardBody(
      tags$style(HTML(paste0("
        .skin-blue .main-header .navbar { background-color: ", ccaf_colors$primary, " !important; }
        .skin-blue .main-header .logo { background-color: ", ccaf_colors$dark, " !important; color: white !important; }
        .main-header .logo .logo-lg { color: white !important; font-weight: bold !important; }
        .skin-blue .main-header .logo:hover { background-color: ", ccaf_colors$primary, " !important; }
        .skin-blue .sidebar-menu > li.header { background: ", ccaf_colors$primary, " !important; color: white !important; }
        .skin-blue .sidebar-menu > li > a { color: white !important; }
        .skin-blue .sidebar-menu > li:hover > a,
        .skin-blue .sidebar-menu > li.active > a { background-color: ", ccaf_colors$primary, " !important; }
        .content-wrapper, .right-side { background-color: ", ccaf_colors$dark, " !important; }
        .box { background: ", ccaf_colors$secondary, " !important; border-top: none !important; color: white !important; }
        .box-header { background: ", ccaf_colors$secondary, " !important; color: white !important; }
                ...
                fluidRow(
                  box(title = "References", status = "info", solidHeader = TRUE, width = 12, collapsible = FALSE,
                    ...
                    Carbon accounting and renewable energy measurement methodologies."),
                          p("Dashboad built by J. Francisco Zubizarreta-R. jfz22 - For Cambridge Centre for Alternative Finance.")
                      )
                  )
                )
        ),
