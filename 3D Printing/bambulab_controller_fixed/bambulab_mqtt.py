...
class BambulabPrinter:
    ...
    def on_connect(self, client, userdata, flags, rc):
        ...
        if rc == 0:
            print(json.dumps({"status": "connected", "message": "Successfully connected to printer"}))
            ...
            print(json.dumps({"status": "error", "message": f"Connection failed with code {rc}"}), file=sys.stderr)
