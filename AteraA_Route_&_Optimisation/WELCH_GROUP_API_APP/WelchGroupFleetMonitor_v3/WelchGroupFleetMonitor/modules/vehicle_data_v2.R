  ...
  tagList(
    div(class = "wg-page-header",
      ...
      div(style = "margin-top:10px;padding:10px 16px;background:#edfaf9;border-left:4px solid #1a6faf;border-radius:6px;",
        tags$b(style = "color:#006b63;", "\U0001f4da Ch 3, 5, 8, 9: "),
          ...
          div(class = "wg-card-body",
            tabsetPanel(id = ns("v2_result_tabs"),
              ...
              tabPanel("Data Table",
                ...
                div(style = "margin-bottom:12px;padding:10px 14px;background:#f0faf9;border-left:3px solid #1a6faf;border-radius:4px;",
                  tags$b(style = "color:#006b63;",
                    tags$i(class = "fa fa-database", style = "margin-right:6px;"),
                    "[Ch3] SQLAlchemy Field Mapping"
                  ),
                  tags$br(),
                  tags$small(style = "color:#5a7a77;",
              ...
              tabPanel("Field Explorer [Ch5]",
                tags$br(),
                div(style = "padding:10px 14px;background:#f0faf9;border-left:3px solid #1a6faf;border-radius:4px;margin-bottom:14px;",
                  tags$b(style = "color:#006b63;",
              ...
              tabPanel("EV Analytics [Ch3/Ch5]",
                tags$br(),
                div(style = "padding:10px 14px;background:#f0faf9;border-left:3px solid #28a745;border-radius:4px;margin-bottom:14px;",
              ...
              tabPanel("Pagination [Ch8]",
                tags$br(),
                div(style = "padding:10px 14px;background:#f0faf9;border-left:3px solid #fd7e14;border-radius:4px;margin-bottom:14px;",
              ...
              tabPanel("Raw JSON",
                ...
                div(style = "background:#f0faf9;border:1px solid #b2e0dd;border-radius:4px;max-height:600px;overflow:auto;padding:12px;",
  ...
  moduleServer(id, function(input, output, session) {
      ...
      if (length(cache) == 0) {
        ...
        make_label <- function(v) {
          ...
          as.character(tags$span(
            ...
            tags$br(),
            tags$small(style = "color:#007a73;font-family:monospace;font-size:10px;", vin)
          ))
        }
    ...
    output$v2_resolved_vins_display <- renderUI({
      ...
      if ("ALL" %in% sel) {
        ...
        div(style = "margin-top:6px;padding:5px 8px;background:#f0faf9;border-left:2px solid #1a9b9b;border-radius:2px;",
        ...
        div(style = "margin-top:6px;padding:5px 8px;background:#f0faf9;border-left:2px solid #1a9b9b;border-radius:2px;",
          tags$small(style = "color:#007a73;font-size:10px;",
    ...
    output$v2_cache_hint <- renderUI({
      ...
      div(style = "margin-top:8px;padding:7px 10px;background:#edfaf9;border-left:3px solid #fd7e14;border-radius:3px;",
    ...
    output$v2_field_explorer_ui <- renderUI({
      ...
      if (qtype != "statuses" && qtype != "everything") {
        return(div(style="color:#5a7a77;padding:12px;",
      ...
      colours <- c("#1a9b9b","#fd7e14","#28a745","#6f42c1","#17a2b8","#dc3545","#6c8a87")
      ...
      tagList(
        lapply(seq_along(section_map), function(i) {
          ...
          div(style = paste0("margin-bottom:14px;padding:10px 14px;background:#ffffff;",
            ...
            if (length(present) > 0)
              div(style = "margin-top:6px;display:flex;flex-wrap:wrap;gap:4px;",
                lapply(present, function(f) {
                  ...
                  HTML(sprintf(
                    '<span style="background:#f0faf9;border:1px solid %s;padding:3px 8px;border-radius:4px;font-size:11px;font-family:monospace;">
                      <span style="color:%s;">%s</span>
                      <span style="color:#007a73;"> %d%%</span>
                    </span>', col, col, f, pct
                  ))
                })
              )
    ...
    .dark <- function(title) list(
      ...
      legend=list(font=list(color="#6c8a87")), font=list(color="#6c8a87")
    )
      ...
      plotly::plot_ly(tbl,r=~Freq,theta=~bins,type="barpolar",
        ...
        plotly::layout(!!!.dark("Heading Distribution"),
                       polar=list(bgcolor="#1a2d45",
                                  radialaxis=list(color="#6c8a87"),
                                  angularaxis=list(color="#6c8a87")))
    })
    ...
    output$v2_speed_heatmap <- plotly::renderPlotly({
      ...
      plotly::plot_ly(tbl, x=~hour, y=~VIN, z=~spd, type="heatmap",
        ...
        plotly::layout(!!!.dark("Avg Speed by Hour of Day (km/h)"),
                       ...
                       yaxis=list(title="VIN",color="#6c8a87"))
    })
