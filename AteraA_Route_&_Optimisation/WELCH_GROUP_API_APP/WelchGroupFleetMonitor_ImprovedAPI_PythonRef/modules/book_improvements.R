...
book_improvements_ui <- function(id) {
  ...
  make_metric_card <- function(value, label, colour) {
    HTML(paste0(
      '<div style="flex:1;min-width:130px;background:#1e2a3a;border-left:4px solid ', colour, ';',
      'padding:12px 16px;border-radius:6px;">',
      '<div style="font-size:28px;font-weight:800;color:#e0eaf5;">', value, '</div>',
      '<div style="font-size:11px;color:#8fa0b5;text-transform:uppercase;letter-spacing:.5px;">', label, '</div>',
      '</div>'
    ))
  }
            ...
            div(style = "margin-bottom:14px;",
              ...
              div(style = "display:flex;flex-wrap:wrap;gap:6px;",
                lapply(list(
                  ...
                  HTML(paste0(
                    '<span style="background:#1a2d45;border:1px solid ', r[[2]], ';padding:4px 10px;border-radius:4px;font-size:11px;font-family:monospace;">',
                    '<b style="color:', r[[2]], ';">', r[[1]], '</b> ',
                    '<span style="color:#8fa0b5;">', r[[3]], '</span></span>'
                  ))
                })
              )
            ),
              ...
              tags$thead(
                tags$tr(
                  lapply(c("Bug / Improvement","Chapter","Original","v2 Behaviour","Tab"),
                    function(h)
                      tags$th(style = "color:#7ec8e3;padding:8px 10px;text-align:left;border-bottom:2px solid #253a52;background:#131e2b;", h))
                )
              ),
              tags$tbody(
                lapply(list(
