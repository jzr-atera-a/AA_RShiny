  ...
  tagList(
    ...
    div(class = "wg-page-header",
      ...
      div(style = "margin-top:10px;padding:10px 16px;background:#1a2d45;border-left:4px solid #1a6faf;border-radius:6px;",
        tags$b(style = "color:#7ec8e3;", "\U0001f4da Ch 1 \u2014 REST, HTTP & JSON: "),
      ...
      column(4,
        div(class = "wg-card",
          ...
          div(class = "wg-card-body",
            ...
            div(style = "padding:8px 12px;background:#0d1921;border-left:3px solid #1a6faf;border-radius:3px;margin-bottom:12px;",
            ...
            lapply(list(
              ...
              div(class = "wg-endpoint-ref", style = "margin-bottom:12px;",
                div(style = "display:flex;align-items:center;gap:8px;margin-bottom:4px;",
                  ...
                  tags$b(style = "color:#7ec8e3;font-family:monospace;font-size:12px;", ep$path),
                  tags$span(style = "background:#1a3a4a;color:#1a9b9b;padding:2px 8px;border-radius:10px;font-size:10px;", ep$freq)
                ),
                tags$p(style = "color:#8fa0b5;font-size:12px;margin:2px 0;", ep$desc),
                tags$p(style = "color:#4a7a9b;font-size:11px;font-family:monospace;margin:2px 0;",
        ...
        div(class = "wg-card", style = "margin-top:16px;",
          ...
          div(class = "wg-card-body",
            tags$table(style = "width:100%;font-size:12px;",
              tags$thead(
                tags$tr(
                  tags$th(style = "color:#7ec8e3;padding:4px 8px;", "Code"),
                  tags$th(style = "color:#7ec8e3;padding:4px 8px;", "Meaning"),
                  tags$th(style = "color:#7ec8e3;padding:4px 8px;", "Volvo API cause")
                )
              ),
              tags$tbody(
                lapply(list(
                  ...
                  tags$tr(
                    ...
                    tags$td(style = "padding:4px 8px;color:#c8d8e4;", row[[3]]),
                    tags$td(style = "padding:4px 8px;color:#8fa0b5;", row[[4]])
                  )
                })
              )
            )
      ...
      column(8,
        ...
        div(class = "wg-card", style = "margin-top:16px;",
          ...
          div(class = "wg-card-body",
            ...
            div(style = "background:#0d1921;border:1px solid #253a52;border-radius:4px;max-height:380px;overflow:auto;padding:12px;",
  ...
  moduleServer(id, function(input, output, session) {
    ...
    output$v2_endpoint_test_ui <- renderUI({
      ...
      tagList(
        lapply(tests, function(t) {
          ...
          div(style = paste0("padding:10px 14px;margin-bottom:8px;background:#1e2a3a;",
            ...
            tags$p(style = "color:#c8d8e4;margin:4px 0 2px;font-size:13px;", t$message),
            tags$p(style = "color:#4a7a9b;margin:0;font-size:11px;", t$note)
          )
        })
      )
    })
    ...
    output$v2_vehicle_dt <- DT::renderDataTable({
      ...
      DT::datatable(
        ...
        DT::formatStyle("VIN",
          backgroundColor = "#1e2a3a", color = "#7ec8e3", fontWeight = "bold")
    })
